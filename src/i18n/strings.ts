...
const en = {
  ...
  openStoryBoard: 'Open Story Board',
  ...
  createStoryBoardPrompt: 'Create Story Board?',
  createStoryBoardMessage: 'No story board found. Would you like to create one?',
  ...
  errorOpeningStoryBoard: 'Error opening story board. See console for details.',
  ...
  // Economy
  createNewEconomy: 'Create new economy',
  createEconomy: 'Create economy',
  editEconomy: 'Edit economy',
  deleteEconomy: 'Delete economy',
  viewEconomies: 'View economies',
  economies: 'Economies',
  economy: 'Economy',
  economicSystem: 'Economic System',
  economicSystemDesc: 'Type of economic organization',
  economyNameDesc: 'Name of the economic system (e.g., "Kingdom of Eldoria Economy")',
  industries: 'Industries',
  industriesDesc: 'Major industries, production, and economic activities',
  taxation: 'Taxation & Trade Policy',
  taxationDesc: 'Tax system, trade regulations, and economic policies',
  representativeImage: 'Representative Image',
  barterEconomy: 'Barter Economy',
  marketEconomy: 'Market Economy',
  commandEconomy: 'Command Economy',
  mixedEconomy: 'Mixed Economy',
  feudalEconomy: 'Feudal Economy',
  giftEconomy: 'Gift Economy',
  booming: 'Booming',
  growing: 'Growing',
  recession: 'Recession',
  depression: 'Depression',
  recovering: 'Recovering',
  economyNameRequired: 'Economy name is required',
  noEconomiesFound: 'No economies found',
  searchEconomies: 'Search economies...',
  confirmDeleteEconomy: (name: string) => `Are you sure you want to delete economy "${name}"? This will move the note to system trash.`,
  economyCreated: (name: string) => `Economy "${name}" created.`,
  economyUpdated: (name: string) => `Economy "${name}" updated.`,
  economyDeleted: (name: string) => `Economy "${name}" deleted.`,
  // Culture
  createNewCulture: 'Create new culture',
  createCulture: 'Create culture',
  editCulture: 'Edit culture',
  deleteCulture: 'Delete culture',
  viewCultures: 'View cultures',
  cultures: 'Cultures',
  culture: 'Culture',
  cultureNameDesc: 'Name of the culture or society',
  techLevel: 'Technology Level',
  techLevelDesc: 'Technological advancement of the culture',
  governmentType: 'Government Type',
  governmentTypeDesc: 'Political system and leadership structure',
  languages: 'Languages',
  languagesDesc: 'Comma-separated list of languages spoken (e.g., Common, Elvish, Dwarvish)',
  population: 'Population',
  populationDesc: 'Estimated population size (e.g., "10,000" or "Large")',
  valuesBeliefs: 'Values & Beliefs',
  valuesBeliefsDesc: 'Core cultural values, worldview, and philosophical beliefs',
  religion: 'Religion',
  religionDesc: 'Religious beliefs, practices, and deities worshipped',
  socialStructure: 'Social Structure',
  socialStructureDesc: 'Class hierarchy, social organization, and caste systems',
  namingConventions: 'Naming Conventions',
  namingConventionsDesc: 'How members of this culture name people, places, and things',
  customsTraditions: 'Customs & Traditions',
  customsTraditionsDesc: 'Cultural practices, ceremonies, holidays, and traditions',
  stoneAge: 'Stone Age',
  ...
  extinct: 'Extinct',
  emerging: 'Emerging',
  cultureNameRequired: 'Culture name is required',
  noCulturesFound: 'No cultures found',
  searchCultures: 'Search cultures...',
  confirmDeleteCulture: (name: string) => `Delete culture "${name}"? This will move the note to system trash.`,
  cultureCreated: (name: string) => `Culture "${name}" created.`,
  cultureUpdated: (name: string) => `Culture "${name}" updated.`,
  cultureDeleted: (name: string) => `Culture "${name}" deleted.`,
  // MagicSystem
  createNewMagicSystem: 'Create new magic system',
  createMagicSystem: 'Create magic system',
  editMagicSystem: 'Edit magic system',
  deleteMagicSystem: 'Delete magic system',
  viewMagicSystems: 'View magic systems',
  magicSystems: 'Magic Systems',
  magicSystem: 'Magic System',
  magicSystemNameDesc: 'Name of the magic system (e.g., "Arcane Arts", "Divine Magic")',
  systemType: 'System Type',
  systemTypeDesc: 'Source or category of magical power',
  rarity: 'Rarity',
  rarityDesc: 'How common is magic in the world?',
  powerLevel: 'Power Level',
  powerLevelDesc: 'Overall potency of this magic system',
  rulesMechanics: 'Rules & Mechanics',
  rulesMechanicsDesc: 'How magic is used, cast, or channeled',
  source: 'Source',
  sourceDesc: 'Where does magical power come from?',
  costsConsequences: 'Costs & Consequences',
  costsConsequencesDesc: 'What does using magic cost the caster?',
  limitations: 'Limitations',
  limitationsDesc: 'What are the boundaries and restrictions of this magic?',
  trainingLearning: 'Training & Learning',
  trainingLearningDesc: 'How is magic learned and mastered?',
  ...
  forbidden: 'Forbidden',
  lostKnowledge: 'Lost Knowledge',
  resurgent: 'Resurgent',
  magicSystemNameRequired: 'Magic system name is required',
  noMagicSystemsFound: 'No magic systems found',
  searchMagicSystems: 'Search magic systems...',
  confirmDeleteMagicSystem: (name: string) => `Delete magic system "${name}"? This will move the note to system trash.`,
  magicSystemCreated: (name: string) => `Magic System "${name}" created.`,
  magicSystemUpdated: (name: string) => `Magic System "${name}" updated.`,
  magicSystemDeleted: (name: string) => `Magic System "${name}" deleted.`,
  // Shared template keys
  startFromTemplate: 'Start from Template',
  startFromTemplateDesc: 'Optionally start with a pre-configured template',
  chooseTemplate: 'Choose Template',
  selectTemplate: 'Select a template',
  templateApplied: (name: string) => `Template "${name}" applied`,
  noTemplatesAvailable: 'This template does not contain any items',
  cannotDeleteWithoutPath: 'Cannot delete without file path.',
  cannotOpenWithoutPath: 'Cannot open note without file path.',
  // Templates tab
  templates: 'Templates',
  entityTemplates: 'Entity Templates',
  browseManageTemplates: 'Browse and manage reusable templates for characters, locations, and other entities.',
  createNewTemplate: 'Create New Template',
  templateCreated: (name: string) => `Template "${name}" created!`,
  searchTemplates: 'Search',
  searchTemplatesPlaceholder: 'Search templates by name, description, or tags...',
  genre: 'Genre',
  ...
  fullWorld: 'Full World',
  sortBy: 'Sort By',
  sortByName: 'Name',
  sortByUsage: 'Usage Count',
  sortByRecent: 'Recently Used',
  showBuiltIn: 'Show Built-in',
  showCustom: 'Show Custom',
  noTemplatesFound: 'No templates found. Try adjusting your filters or create a new template.',
  foundXTemplates: (count: number) => `Found ${count} template${count !== 1 ? 's' : ''}`,
  builtIn: 'Built-in',
  usedXTimes: (count: number) => `Used: ${count}x`,
  contains: 'Contains: ',
  useTemplate: 'Use Template',
  duplicate: 'Duplicate',
  templateSelected: (name: string) => `Template "${name}" selected. Apply this template from the entity creation modal.`,
  templateDeleted: (name: string) => `Template "${name}" deleted.`,
  failedToDeleteTemplate: (error: string) => `Failed to delete template: ${error}`,
  templateCopySuffix: ' (Copy)',
  templateDuplicated: (name: string) => `Template duplicated as "${name}"`,
  failedToDuplicateTemplate: (error: string) => `Failed to duplicate template: ${error}`,
  deleteTemplate: 'Delete Template?',
  confirmDeleteTemplate: (name: string) => `Are you sure you want to delete the template "${name}"? This action cannot be undone.`,
  // Settings - Dashboard Tab Visibility
  dashboardTabVisibility: 'Dashboard Tab Visibility',
  dashboardTabVisibilityDesc: 'Choose which tabs to show in the dashboard sidebar. Hidden tabs will not appear in the tab bar.',
  tabIsVisible: 'Tab is visible',
  tabIsHidden: 'Tab is hidden',
  tabShown: (name: string) => `${name} tab shown`,
  tabHidden: (name: string) => `${name} tab hidden`,
  refreshDashboardToSeeChanges: '. Refresh the dashboard to see changes.',
  // Settings - Gantt View
  ganttViewSettings: 'Gantt View Settings',
  showProgressBarsInGantt: 'Show progress bars in Gantt view',
  showProgressBarsInGanttDesc: 'Display progress bar overlays on Gantt bars to visualize event completion.',
  defaultGanttDuration: 'Default Gantt duration (days)',
  defaultGanttDurationDesc: 'Default duration in days for events without an end date when shown in Gantt view.',
  dependencyArrowStyle: 'Dependency arrow style',
  dependencyArrowStyleDesc: 'Visual style for dependency arrows between events in Gantt view.',
  solid: 'Solid',
  dashed: 'Dashed',
  dotted: 'Dotted',
  // Settings - Map
  mapSettings: 'Map Settings',
  enableFrontmatterMarkers: 'Enable frontmatter markers',
  enableFrontmatterMarkersDesc: 'Auto-generate markers from notes with location or mapmarkers in frontmatter',
  enableDataViewMarkers: 'Enable DataView markers',
  enableDataViewMarkersDesc: 'Auto-generate markers from DataView queries (requires DataView plugin)',
};
...
const zh = {
  ...
  economy: '经济',
  economicSystem: '经济体系',
  economicSystemDesc: '经济组织类型',
  economyNameDesc: '经济体系的名称（例如："埃尔多利亚王国经济"）',
  industries: '产业',
  industriesDesc: '主要产业、生产和经济活动',
  taxation: '税收与贸易政策',
  taxationDesc: '税收体系、贸易法规和经济政策',
  representativeImage: '代表图像',
  barterEconomy: '物物交换经济',
  marketEconomy: '市场经济',
  commandEconomy: '计划经济',
  mixedEconomy: '混合经济',
  feudalEconomy: '封建经济',
  ...
  depression: '萧条',
  recovering: '复苏',
  economyNameRequired: '经济名称为必填项',
  noEconomiesFound: '未找到经济',
  searchEconomies: '搜索经济...',
  confirmDeleteEconomy: (name: string) => `确定要删除经济"${name}"吗？这将把笔记移至系统回收站。`,
  economyCreated: (name: string) => `经济"${name}"已创建。`,
  economyUpdated: (name: string) => `经济"${name}"已更新。`,
  economyDeleted: (name: string) => `经济"${name}"已删除。`,
  // Culture
  createNewCulture: '创建新文化',
  createCulture: '创建文化',
  editCulture: '编辑文化',
  deleteCulture: '删除文化',
  viewCultures: '查看文化',
  cultures: '文化',
  culture: '文化',
  cultureNameDesc: '文化或社会的名称',
  techLevel: '科技水平',
  techLevelDesc: '文化的科技进步水平',
  governmentType: '政府类型',
  governmentTypeDesc: '政治体制和领导结构',
  languages: '语言',
  languagesDesc: '以逗号分隔的语言列表（例如：通用语、精灵语、矮人语）',
  population: '人口',
  populationDesc: '估计人口规模（例如："10,000"或"大"）',
  valuesBeliefs: '价值观和信仰',
  valuesBeliefsDesc: '核心文化价值观、世界观和哲学信仰',
  religion: '宗教',
  religionDesc: '宗教信仰、实践和崇拜的神灵',
  socialStructure: '社会结构',
  socialStructureDesc: '阶级等级、社会组织和种姓制度',
  namingConventions: '命名规则',
  namingConventionsDesc: '该文化成员如何命名人物、地点和事物',
  customsTraditions: '习俗与传统',
  customsTraditionsDesc: '文化习俗、仪式、节日和传统',
  stoneAge: '石器时代',
  bronzeAge: '青铜时代',
  ironAge: '铁器时代',
  medieval: '中世纪',
  ...
  extinct: '灭绝',
  emerging: '新兴',
  cultureNameRequired: '文化名称为必填项',
  noCulturesFound: '未找到文化',
  searchCultures: '搜索文化...',
  confirmDeleteCulture: (name: string) => `删除文化"${name}"？这将把笔记移至系统回收站。`,
  cultureCreated: (name: string) => `文化"${name}"已创建。`,
  cultureUpdated: (name: string) => `文化"${name}"已更新。`,
  cultureDeleted: (name: string) => `文化"${name}"已删除。`,
  // MagicSystem
  createNewMagicSystem: '创建新魔法系统',
  createMagicSystem: '创建魔法系统',
  editMagicSystem: '编辑魔法系统',
  deleteMagicSystem: '删除魔法系统',
  viewMagicSystems: '查看魔法系统',
  magicSystems: '魔法系统',
  magicSystem: '魔法系统',
  magicSystemNameDesc: '魔法系统的名称（例如："奥术艺术"、"神圣魔法"）',
  systemType: '系统类型',
  systemTypeDesc: '魔法力量的来源或类别',
  rarity: '稀有度',
  rarityDesc: '魔法在世界中有多常见？',
  powerLevel: '力量等级',
  powerLevelDesc: '该魔法系统的整体威力',
  rulesMechanics: '规则与机制',
  rulesMechanicsDesc: '魔法如何使用、施放或传导',
  source: '来源',
  sourceDesc: '魔法力量从何而来？',
  costsConsequences: '代价与后果',
  costsConsequencesDesc: '使用魔法对施法者的代价是什么？',
  limitations: '限制',
  limitationsDesc: '该魔法的边界和限制是什么？',
  trainingLearning: '训练与学习',
  trainingLearningDesc: '魔法如何学习和掌握？',
  arcane: '奥术（学习型）',
  divine: '神圣（信仰型）',
  natural: '自然（自然/德鲁伊）',
  psionic: '灵能（心灵力量）',
  ...
  lostKnowledge: '失传知识',
  resurgent: '复苏',
  magicSystemNameRequired: '魔法系统名称为必填项',
  noMagicSystemsFound: '未找到魔法系统',
  searchMagicSystems: '搜索魔法系统...',
  confirmDeleteMagicSystem: (name: string) => `删除魔法系统"${name}"？这将把笔记移至系统回收站。`,
  magicSystemCreated: (name: string) => `魔法系统"${name}"已创建。`,
  magicSystemUpdated: (name: string) => `魔法系统"${name}"已更新。`,
  magicSystemDeleted: (name: string) => `魔法系统"${name}"已删除。`,
  // Shared template keys
  startFromTemplate: '从模板开始',
  startFromTemplateDesc: '可选择从预配置的模板开始',
  chooseTemplate: '选择模板',
  selectTemplate: '选择一个模板',
  templateApplied: (name: string) => `已应用模板"${name}"`,
  noTemplatesAvailable: '此模板不包含任何项目',
  cannotDeleteWithoutPath: '没有文件路径无法删除。',
  cannotOpenWithoutPath: '没有文件路径无法打开笔记。',
  // Templates tab
  templates: '模板',
  entityTemplates: '实体模板',
  browseManageTemplates: '浏览和管理可重用的角色、位置和其他实体模板。',
  createNewTemplate: '创建新模板',
  templateCreated: (name: string) => `模板"${name}"已创建！`,
  searchTemplates: '搜索',
  searchTemplatesPlaceholder: '按名称、描述或标签搜索模板...',
  genre: '类型',
  allGenres: '所有类型',
  templateCategory: '类别',
  allTemplateCategories: '所有类别',
  singleEntity: '单个实体',
  entitySet: '实体集合',
  fullWorld: '完整世界',
  sortBy: '排序方式',
  ...
  showBuiltIn: '显示内置',
  showCustom: '显示自定义',
  noTemplatesFound: '未找到模板。请尝试调整筛选条件或创建新模板。',
  foundXTemplates: (count: number) => `找到 ${count} 个模板`,
  builtIn: '内置',
  usedXTimes: (count: number) => `已使用：${count}次`,
  contains: '包含：',
  useTemplate: '使用模板',
  duplicate: '复制',
  templateSelected: (name: string) => `模板"${name}"已选择。从实体创建模态框应用此模板。`,
  templateDeleted: (name: string) => `模板"${name}"已删除。`,
  failedToDeleteTemplate: (error: string) => `删除模板失败：${error}`,
  templateCopySuffix: '（副本）',
  templateDuplicated: (name: string) => `模板已复制为"${name}"`,
  failedToDuplicateTemplate: (error: string) => `复制模板失败：${error}`,
  deleteTemplate: '删除模板？',
  confirmDeleteTemplate: (name: string) => `确定要删除模板"${name}"吗？此操作无法撤销。`,
  // Settings - Dashboard Tab Visibility
  dashboardTabVisibility: '仪表板标签页可见性',
  dashboardTabVisibilityDesc: '选择在仪表板侧边栏中显示哪些标签页。隐藏的标签页不会出现在标签栏中。',
  tabIsVisible: '标签页可见',
  tabIsHidden: '标签页已隐藏',
  tabShown: (name: string) => `${name} 标签页已显示`,
  tabHidden: (name: string) => `${name} 标签页已隐藏`,
  refreshDashboardToSeeChanges: '。刷新仪表板以查看更改。',
  // Settings - Gantt View
  ganttViewSettings: '甘特图视图设置',
  showProgressBarsInGantt: '在甘特图视图中显示进度条',
  showProgressBarsInGanttDesc: '在甘特图条形图上显示进度条叠加层，以可视化事件完成情况。',
  defaultGanttDuration: '默认甘特图持续时间（天）',
  defaultGanttDurationDesc: '在甘特图视图中显示没有结束日期的事件的默认持续时间（天）。',
  dependencyArrowStyle: '依赖箭头样式',
  dependencyArrowStyleDesc: '甘特图视图中事件之间依赖箭头的视觉样式。',
  solid: '实线',
  dashed: '虚线',
  dotted: '点线',
  // Settings - Map
  mapSettings: '地图设置',
  enableFrontmatterMarkers: '启用前置元数据标记',
  enableFrontmatterMarkersDesc: '从带有位置或地图标记的前置元数据的笔记中自动生成标记',
  enableDataViewMarkers: '启用数据视图标记',
  enableDataViewMarkersDesc: '从数据视图查询中自动生成标记（需要数据视图插件）',
};
